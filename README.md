...
**Версия:** 0.5.1 · **Стек:** React 19, Next.js 16, Kotlin/Ktor, PostgreSQL 18, Docker Compose, Caddy.
...
В `curl` замените домен своим. Compose запускает подготовку ролей БД и отдельный процесс миграций перед API; текущая схема включает V17.
