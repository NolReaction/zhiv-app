...
**Версия:** 0.5.2 · **Стек:** React 19, Next.js 16, Kotlin/Ktor, PostgreSQL 18, Docker Compose, Caddy.
...
- Компактный профиль с раскрывающимися настройками и единое меню добавления людей.
