...
**Версия 0.6.5:** обновлённый лес, день и ночь, свет, дождь и живая природа; справка, новости и обращения разработчику. [Описание релиза и обновление с 0.6.3](docs/releases/release-0.6.5.md). Новые путешествия, строительство и крафт временно отключены на время переноса мира; сохранённый прогресс остаётся. Ограничения задаёт [`presentation.ts`](features/world/presentation.ts).
