...
**Версия:** 0.6.0 · **Стек:** React 19, Next.js 16, Kotlin/Ktor, PostgreSQL 18, Docker Compose, Caddy.
...
В `curl` замените домен своим. Compose запускает подготовку ролей БД и отдельный процесс миграций перед API; текущая схема ветки включает V24 (обновлённые достижения Мохлика).
...
- [Изменения 0.6.0](docs/release-0.6.0.md)
- [Изменения 0.5.8](docs/release-0.5.8.md)
