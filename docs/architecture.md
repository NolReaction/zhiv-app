> Базовый релиз — 0.6.0. Развитие мира описано в [world-foundation.md](world-foundation.md). Ниже — исторический обзор: [вход через ВК и почту](auth-0.5.0.md), [изменения](release-0.5.0.md), [развёртывание](../README.md). Ниже сохранены исходные проектные решения; разделы восстановления через друзей исторические и не описывают действующий резервный код.
