...
Самостоятельный PNG с прозрачностью: `art/world/main/boat-wreck.png`, 1619×971. Создан одним запросом встроенного imagegen; исходный файл сохранён вместе с alpha. Фон леса использован только как визуальный ориентир и не изменялся. При загрузке Canvas один раз делает спрайт 96×59 для той же плотности пикселей, что у карты. Мировая опора `(898,956)`; корма касается берега, нос направлен вправо-вниз.
